...
const primary =
  "w-full bg-amber-600 hover:bg-amber-500 text-ink text-sm py-2.5 rounded-lg disabled:opacity-40 transition-colors";
const ghost =
  ...
  async function begin() {
    ...
    try {
      ...
      const r = await requestNpubProof(
        ...
        `You requested to log in to The Bee's Knees (${window.location.host}).`,
      );
      if (r.error) {
        setError(r.error);
        return;
  ...
  return (
    <div className="max-w-md mx-auto mt-16 px-4">
      <div className="flex items-center gap-2 mb-1">
        ...
        <h1 className="text-lg font-semibold">Sign in to The Bee's Knees</h1>
      </div>
