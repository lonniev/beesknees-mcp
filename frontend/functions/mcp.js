/**
 * Cloudflare Pages Function — proxy /mcp to beesknees-mcp.fastmcp.app/mcp.
 *
...
const UPSTREAM = "https://beesknees-mcp.fastmcp.app/mcp";
...
export async function onRequest(context) {
  ...
  upHeaders.set("Host", "beesknees-mcp.fastmcp.app");
