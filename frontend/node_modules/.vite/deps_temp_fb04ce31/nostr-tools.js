...
function getFilterLimit(filter) {
	...
	for (const [key, value] of Object.entries(filter)) if (key[0] === "#" && Array.isArray(value) && !value.length) return 0;
...
function parseReferences(evt) {
	let references = [];
	for (let ref of evt.content.matchAll(mentionRegex)) if (ref[2]) try {
...
var nip22_exports = {};
__export(nip22_exports, { parse: () => parse3 });
...
var nip27_exports = {};
__export(nip27_exports, { parse: () => parse4 });
var noCharacter = /\W/m;
			...
			for (let e = 0; e < emojis.length; e++) {
				...
				if (content[u + emoji.shortcode.length + 1] === ":" && content.slice(u + 1, u + emoji.shortcode.length + 1) === emoji.shortcode) {
					...
					yield {
						...emoji,
						start: u,
						end: u + emoji.shortcode.length + 2
					};
...
var nip54_exports = {};
__export(nip54_exports, { normalizeIdentifier: () => normalizeIdentifier });
	...
	reconcile(queryMsg, onhave, onneed) {
		...
		while (query.length !== 0) {
			...
			if (mode === Mode.Skip) skip = true;
				...
				if (compareUint8Array(getBytes(query, FINGERPRINT_SIZE), this.storage.fingerprint(lower, upper)) !== 0) {
					doSkip();
...
//#endregion
export { Relay, SimplePool, compareEvents, finalizeEvent, fakejson_exports as fj, generateSecretKey, getEventHash, getFilterLimit, getPublicKey, kinds_exports as kinds, matchFilter, matchFilters, mergeFilters, nip04_exports as nip04, nip05_exports as nip05, nip10_exports as nip10, nip11_exports as nip11, nip13_exports as nip13, nip17_exports as nip17, nip18_exports as nip18, nip19_exports as nip19, nip21_exports as nip21, nip22_exports as nip22, nip25_exports as nip25, nip27_exports as nip27, nip28_exports as nip28, nip30_exports as nip30, nip39_exports as nip39, nip42_exports as nip42, nip44_exports as nip44, nip47_exports as nip47, nip54_exports as nip54, nip57_exports as nip57, nip59_exports as nip59, nip77_exports as nip77, nip98_exports as nip98, parseReferences, serializeEvent, sortEvents, utils_exports as utils, validateEvent, verifiedSymbol, verifyEvent };
